...
import com.cuzer.spring5recipeapp.exceptions.NotFoundException;
...
public class RecipeControllerTest {
	...
	public void setUp() throws Exception {
		...
		mockMvc = MockMvcBuilders.standaloneSetup(controller).setControllerAdvice(new ExceptionHandlerController())
				.build();
	}
	...
	// "")
	// .param("cookTime",
	// "3000")).andExpect(status().is3xxRedirection()).andExpect(model().attributeExists("recipe"))
